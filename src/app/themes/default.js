export default {
  ...
  tableHeader: {
    base:
      'text-sm font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800',
  },
  // TableContainer
  tableContainer: {
    base: 'w-full overflow-hidden rounded-lg ring-1 ring-black ring-opacity-5 w-full overflow-x-auto',
  },
  // TableCell
  tableCell: {
    base: 'px-4 py-3 capitalize',
  },
  // TableBody
  tableBody: {
    base:
  ...
  // Badge
  badge: {
    base: 'inline-flex px-2 text-xs font-medium leading-5 rounded',
    success: 'text-[#394E69] bg-green-100 dark:bg-green-700 dark:text-green-100',
    danger: 'text-[#394E69] bg-red-100 dark:text-red-100 dark:bg-red-700',
    warning: 'text-[#394E69] bg-orange-100 dark:text-white dark:bg-orange-600',
    neutral: 'text-[#394E69] bg-gray-100 dark:text-gray-100 dark:bg-gray-700',
    primary: 'text-[#394E69] bg-blue-100 dark:text-white dark:bg-blue-600',
  },
  // Backdrop
  backdrop: {
    base:
  ...
  // Input
  input: {
    base: 'block w-full text-sm focus:outline-none dark:text-gray-300 leading-5 rounded-md border border-gray-300 pl-10 p-2.5',
    active:
